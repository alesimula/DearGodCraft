...
package com.greenapple.deargodcraft.collections;
 ...
 *
 * Original code: https://github.com/spring-projects/spring-framework/blob/master/spring-core/src/main/java/org/springframework/util/ConcurrentReferenceHashMap.java
 * @author Phillip Webb
...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    private static final int OBJECT_INITIAL_HASH = 7;
    private static final int OBJECT_HASH_MULTIPLIER = 31;
    private static void assertIsTrue(boolean expression, String message) {
        if (!expression) {
            throw new IllegalArgumentException(message);
        }
    }
    private static void assertNotNull(@Nullable Object object, String message) {
        if (object == null) {
            throw new IllegalArgumentException(message);
        }
    }
    ...
    private static boolean objectArrayEquals(Object o1, Object o2) {
    ...
    private static boolean objectNullSafeEquals(@Nullable Object o1, @Nullable Object o2) {
        if (o1 == o2) {
            return true;
        }
        if (o1 == null || o2 == null) {
        ...
        if (o1.getClass().isArray() && o2.getClass().isArray()) {
            return objectArrayEquals(o1, o2);
        }
        return false;
    }
    private static int objectNullSafeHashCode(@Nullable Object obj) {
        if (obj == null) {
            return 0;
        }
        if (obj.getClass().isArray()) {
            if (obj instanceof Object[]) {
                return objectNullSafeHashCode((Object[]) obj);
            }
            if (obj instanceof boolean[]) {
                return objectNullSafeHashCode((boolean[]) obj);
            }
            if (obj instanceof byte[]) {
                return objectNullSafeHashCode((byte[]) obj);
            }
            if (obj instanceof char[]) {
                return objectNullSafeHashCode((char[]) obj);
            }
            if (obj instanceof double[]) {
                return objectNullSafeHashCode((double[]) obj);
            }
            if (obj instanceof float[]) {
                return objectNullSafeHashCode((float[]) obj);
            }
            if (obj instanceof int[]) {
                return objectNullSafeHashCode((int[]) obj);
            }
            if (obj instanceof long[]) {
                return objectNullSafeHashCode((long[]) obj);
            }
            if (obj instanceof short[]) {
                return objectNullSafeHashCode((short[]) obj);
            }
        }
        return obj.hashCode();
    }
    private static int objectNullSafeHashCode(@Nullable Object[] array) {
        if (array == null) {
            return 0;
        }
        int hash = OBJECT_INITIAL_HASH;
        for (Object element : array) {
            hash = OBJECT_HASH_MULTIPLIER * hash + objectNullSafeHashCode(element);
        }
        return hash;
    }
    private static int objectNullSafeHashCode(@Nullable boolean[] array) {
        if (array == null) {
            return 0;
        }
        int hash = OBJECT_INITIAL_HASH;
        for (boolean element : array) {
            hash = OBJECT_HASH_MULTIPLIER * hash + Boolean.hashCode(element);
        }
        return hash;
    }
    private static int objectNullSafeHashCode(@Nullable byte[] array) {
        if (array == null) {
            return 0;
        }
        int hash = OBJECT_INITIAL_HASH;
        for (byte element : array) {
            hash = OBJECT_HASH_MULTIPLIER * hash + element;
        }
        return hash;
    }
    private static int objectNullSafeHashCode(@Nullable char[] array) {
        if (array == null) {
            return 0;
        }
        int hash = OBJECT_INITIAL_HASH;
    ...
    private static int objectNullSafeHashCode(@Nullable double[] array) {
        if (array == null) {
            return 0;
        }
        int hash = OBJECT_INITIAL_HASH;
        for (double element : array) {
            hash = OBJECT_HASH_MULTIPLIER * hash + Double.hashCode(element);
        }
        return hash;
    }
    private static int objectNullSafeHashCode(@Nullable float[] array) {
        if (array == null) {
            return 0;
        }
        int hash = OBJECT_INITIAL_HASH;
        for (float element : array) {
            hash = OBJECT_HASH_MULTIPLIER * hash + Float.hashCode(element);
        }
        return hash;
    }
    private static int objectNullSafeHashCode(@Nullable int[] array) {
        if (array == null) {
            return 0;
        }
        int hash = OBJECT_INITIAL_HASH;
    ...
    private static int objectNullSafeHashCode(@Nullable long[] array) {
        if (array == null) {
            return 0;
        }
        int hash = OBJECT_INITIAL_HASH;
        for (long element : array) {
            hash = OBJECT_HASH_MULTIPLIER * hash + Long.hashCode(element);
        }
        return hash;
    }
    private static int objectNullSafeHashCode(@Nullable short[] array) {
        if (array == null) {
            return 0;
        }
        int hash = OBJECT_INITIAL_HASH;
    ...
    public ConcurrentReferenceHashMap(
        ...
        assertIsTrue(initialCapacity >= 0, "Initial capacity must not be negative");
        assertIsTrue(loadFactor > 0f, "Load factor must be positive");
        assertIsTrue(concurrencyLevel > 0, "Concurrency level must be positive");
    ...
    public boolean containsKey(@Nullable Object key) {
        Reference<K, V> ref = getReference(key, Restructure.WHEN_NECESSARY);
        Entry<K, V> entry = (ref != null ? ref.get() : null);
        return (entry != null && objectNullSafeEquals(entry.getKey(), key));
    }
    ...
    private void setEntry(Entry<K, V> entry, @Nullable Reference<K, V> ref, @Nullable V value) {
        if (entry != null) {
        ...
        else if (value == null && ref != null) ref.release();
        ...
        return doTask(key, new Task<V>(TaskOption.RESTRUCTURE_BEFORE, TaskOption.RESIZE) {
            ...
            protected V execute(@Nullable Reference<K, V> ref, @Nullable Entry<K, V> entry, @Nullable Entries<V> entries) {
                if (entry != null) {
                    ...
                    if (newValue == null) {
                        if (oldValue != null) setEntry(entry, ref, null);
                        return null;
                    }
                    else {
                        if (oldValue != newValue) entry.setValue(newValue);
                        return newValue;
                    }
                }
                assertState(entries != null, "No entries segment");
                V newValue = remappingFunction.apply(key, null);
                if (newValue != null) entries.add(newValue);
                return newValue;
            }
        });
    }
    ...
    public V computeIfPresent(@Nullable K key, BiFunction<? super K, ? super V, ? extends V> remappingFunction) {
        ...
        return doTask(key, new Task<V>(TaskOption.RESTRUCTURE_BEFORE, TaskOption.SKIP_IF_EMPTY) {
            ...
            protected V execute(@Nullable Reference<K, V> ref, @Nullable Entry<K, V> entry, @Nullable Entries<V> entries) {
                V oldValue;
                if (entry != null && (oldValue = entry.getValue()) != null) {
                    V newValue = remappingFunction.apply(key, oldValue);
                    if (oldValue != newValue) setEntry(entry, ref, newValue);
                    return newValue;
                }
                return null;
            }
    ...
    public V computeIfAbsent(K key, Function<? super K, ? extends V> mappingFunction) {
        ...
        return doTask(key, new Task<V>(TaskOption.RESTRUCTURE_BEFORE, TaskOption.RESIZE) {
            ...
            protected V execute(@Nullable Reference<K, V> ref, @Nullable Entry<K, V> entry, @Nullable Entries<V> entries) {
                V oldValue = null;
                if (entry != null) {
                    if ((oldValue = entry.getValue()) == null) {
                        V newValue = mappingFunction.apply(key);
                        if (newValue != null) setEntry(entry, ref, newValue);
                        return newValue;
                    }
                    return oldValue;
                }
    ...
    public boolean remove(Object key, final Object value) {
        Boolean result = doTask(key, new Task<Boolean>(TaskOption.RESTRUCTURE_AFTER, TaskOption.SKIP_IF_EMPTY) {
            ...
            protected Boolean execute(@Nullable Reference<K, V> ref, @Nullable Entry<K, V> entry) {
                if (entry != null && objectNullSafeEquals(entry.getValue(), value)) {
                    if (ref != null) {
                        ref.release();
                    }
                    return true;
    ...
    public boolean replace(K key, final V oldValue, final V newValue) {
        Boolean result = doTask(key, new Task<Boolean>(TaskOption.RESTRUCTURE_BEFORE, TaskOption.SKIP_IF_EMPTY) {
            @Override
            protected Boolean execute(@Nullable Reference<K, V> ref, @Nullable Entry<K, V> entry) {
                if (entry != null && objectNullSafeEquals(entry.getValue(), oldValue)) {
            ...
            while (currRef != null) {
                if (currRef.getHash() == hash) {
                    ...
                    if (entry != null) {
                        ...
                        if (objectNullSafeEquals(entryKey, key)) {
                            return currRef;
                        }
                    }
                }
    ...
    protected static final class Entry<K, V> implements Map.Entry<K, V> {
        ...
        public final boolean equals(@Nullable Object other) {
            ...
            return (objectNullSafeEquals(getKey(), otherEntry.getKey()) &&
                    objectNullSafeEquals(getValue(), otherEntry.getValue()));
        }

        @Override
        public final int hashCode() {
            return (objectNullSafeHashCode(this.key) ^ objectNullSafeHashCode(this.value));
        }
    }
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(@Nullable Object o) {
            if (o instanceof Map.Entry<?, ?>) {
                ...
                if (otherEntry != null) {
                    return objectNullSafeEquals(otherEntry.getValue(), otherEntry.getValue());
                }
            }
            return false;
        }
